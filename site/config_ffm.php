 ...
 */
define('__FFM_VKID__', '4079503');

/**
 * Database settings
 */
// define('__FFM_CONNECT__', 'mysql://farfrommoscowdev:MxtaP9Gq7MHmtdz@localhost/farfrommoscowdevdb');
define('__FFM_CONNECT__', 'mysql://vladp:VfsGKzMrLpw8Ya49@localhost/farfrommoscowdevdb');
define('__CONFIG_NM_DB_CONNECT__', 'mysql://vladp:VfsGKzMrLpw8Ya49@localhost/mapdevdb');

/**
 * Site settings
 */
define('__FFM_HOST__', 'farfrommoscowdev');
define('__FFM_NAME__', 'LOCAL');
define('__NM_HOST__', 'mapdev');
